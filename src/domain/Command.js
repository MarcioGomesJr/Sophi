/*
    Classe para representar comandos do bot. A função shouldExecute recebe a mensagem e retorna true e
    o texto que será usado como argumento para o comando caso o comando deva ser executado, e retorna
    false e '' caso não deva.
